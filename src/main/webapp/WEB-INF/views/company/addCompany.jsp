                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-4">Save Client</h1>
                                                            </div>
                                                            <form class="user">
                                                                <div class="custom-checkbox">
                                                                    Prospect
                                                                    <form:checkbox path="prospect" id="prospectId"/>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <form:errors path="name"
                                                                                 cssClass="error">Must not be blank and must contain at least 2 characters</form:errors>
                                                                    <c:if test="${addNameFail == true}">
                                                                        Name already exist
                                                                    </c:if>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <form:input path="city"
                                                                                class="form-control form-control-user"
                                                                                id="cityId" placeholder="City"/>
                                                                    <form:errors path="city"
                                                                                 cssClass="error">Must not be blank and must contain at least 3 characters</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Postal Code
                                                                    ...
                                                                    <form:errors path="postalCode"
                                                                                 cssClass="error">Must not be blank and must contain 6 characters</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Cell Phone
                                                                    ...
                                                                    <form:errors path="cellPhone"
                                                                                 cssClass="error">Must not be blank</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Email
                                                                    <form:input path="email"
                                                                                class="form-control form-control-user"
                                                                                id="addressId" placeholder="email"/>
                                                                    <form:errors path="email"
                                                                                 cssClass="error">This is not an email</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    NIP
                                                                    <form:input path="nip"
                                                                    ...
                                                                    <form:errors path="nip"
                                                                                 cssClass="error">Must be NIP</form:errors>
                                                                    <c:if test="${addNipFail == true}">
                                                                        NIP already exist
                                                                    </c:if>
                                                                </div>
                                                                <div class="form-group">
                                                                    Salesman
                                                                    <form:select path="salesman.id" items="${salesmen}"
                                                                                 itemLabel="fullName" itemValue="id"
                                                                                 class="form-control form-control-user"
                                                                                 id="salesmanId"/>
                                                                    <form:errors path="salesman"
                                                                                 cssClass="error">Salesman must be assigned</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Province
                                                                    <form:select path="province.id" items="${provinces}"
                                                                                 itemLabel="name" itemValue="id"
                                                                                 class="form-control form-control-user"
                                                                                 id="provinceId"/>
                                                                    <form:errors path="province"
                                                                                 cssClass="error">Province must be assigned</form:errors>
                                                                </div>
                                                                <input type="submit"
