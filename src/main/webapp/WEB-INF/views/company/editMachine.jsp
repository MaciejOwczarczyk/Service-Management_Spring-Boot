                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-4">Save Machine</h1>
                                                            </div>
                                                            <form class="user">
                                                                <div class="form-group">
                                                                    Model
                                                                    <form:input path="model" class="form-control form-control-user" id="modelId" placeholder="Model"/>
                                                                    <form:errors path="model" cssClass="error">Must not be blank and must contain at least 3 characters</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Serial Number
                                                                    <form:input path="serialNumber" class="form-control form-control-user" id="addressId" placeholder="S/N"/>
                                                                    <form:errors path="serialNumber" cssClass="error">Must not be blank and must contain at least 2 characters</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Year of production
                                                                    <form:input path="yearOfProduction" type="number" class="form-control form-control-user" id="yearId" placeholder="Year"/>
                                                                    <form:errors path="yearOfProduction" cssClass="error">Must not be blank and must contain 4 characters</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Warranty Start<br/>
                                                                    <form:input type="date" path="warrantyStart" class="form-control" name="warrantyStart" pattern="yyyy-MM-dd"/>
                                                                </div>
                                                                <div class="form-group">
                                                                    Warranty End<br/>
                                                                    <form:input type="date" path="warrantyEnd" class="form-control" name="warrantyEnd" pattern="yyyy-MM-dd"/>
                                                                </div>
                                                                <div class="form-group">
                                                                    Producer
                                                                    <form:select path="producer.id" items="${producers}" itemLabel="name" itemValue="id" class="form-control form-control-user" id="producerId"/>
                                                                    <form:errors path="producer" cssClass="error">Select producer</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Machine Type
                                                                    <form:select path="machineType.id" items="${machineTypes}" itemLabel="name" itemValue="id" class="form-control form-control-user" id="machineTypeId"/>
                                                                    <form:errors path="machineType" cssClass="error">Select machine type</form:errors>
                                                                </div>

                                                                <div class="form-group">
                                                                    Client
                                                                    <form:select path="company.id" items="${companies}" itemLabel="name" itemValue="id" class="form-control form-control-user" id="companyId" readonly="true" value="${machine.company}"/>
                                                                    <form:errors path="company" cssClass="error">Select Client</form:errors>
                                                                </div>

                                                                <input type="hidden" id="own" name="companyId" value="${machine.company.id}">
