        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="container">
                            <form:form method="post" modelAttribute="ticketStatus">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-4">Save status</h1>
                                                            </div>
                                                            <form class="user">
                                                                <div class="form-group">
                                                                    ...
                                                                    <form:input path="name"
                                                                                ...
                                                                                id="statusId" placeholder="Status"/>
                                                                    <form:errors path="name"
                                                                                 cssClass="error">Must not be blank and must contain at least 3 characters</form:errors>
                                                                    <c:if test="${ticketStatusFail == true}">
                                                                        Name already exist
                                                                    </c:if>
                                                                    <label>
                                                                        <input hidden value="${ticketStatus.name}" name="oldName"/>
                                                                    </label>
                                                                </div>
                                                                <input type="submit"
