                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-4">Save Producer</h1>
                                                            </div>
                                                            <form class="user">
                                                                <div class="form-group">
                                                                    ...
                                                                    <form:input path="name"
                                                                                ...
                                                                                id="nameId" placeholder="Name"/>
                                                                    <form:errors path="name"
                                                                                 cssClass="error">Must not be blank and must be grater than 3 signs</form:errors>
                                                                    <c:if test="${producerFail == true}">
                                                                        Producer name already exist
                                                                    </c:if>
                                                                </div>
                                                                <div class="form-group">
                                                                    Address
                                                                    <form:input path="address"
                                                                                class="form-control form-control-user"
                                                                                id="addressId" placeholder="Address"/>
                                                                    <form:errors path="address"
                                                                                 cssClass="error">Must not be blank and must be grater than 4 signs</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    City
                                                                    ...
                                                                    <form:errors path="city"
                                                                                 cssClass="error">Must not be blank and must contain 3 signs</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Postal Code
                                                                    ...
                                                                    <form:errors path="postalCode"
                                                                                 cssClass="error">Must not be blank and must contain 5 signs</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Country
                                                                    <form:select path="country.id" items="${countries}"
                                                                                 itemLabel="name" itemValue="id"
                                                                                 class="form-control form-control-user"
                                                                                 id="countryId"/>
                                                                    <form:errors path="country"
                                                                                 cssClass="error">Select Country</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Phone
                                                                    <form:input path="phone"
                                                                                class="form-control form-control-user"
                                                                                id="phoneId" placeholder="Phone"/>
                                                                    <form:errors path="phone"
                                                                                 cssClass="error">Must not be blank and must contain 9 signs</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Email
