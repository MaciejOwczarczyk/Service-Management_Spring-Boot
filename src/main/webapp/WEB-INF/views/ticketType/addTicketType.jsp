                        ...
                        <div class="container">
                            <form:form method="post" modelAttribute="ticketType">
                                ...
                                <div class="row justify-content-sm-start">
                                    ...
                                    <div class="col-xl-8 col-lg-2 col-md-5">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-4">Save type</h1>
                                                            </div>
                                                            <form class="user">
                                                                <div class="form-group">
                                                                    Status
                                                                    <form:input path="name" class="form-control form-control-user" id="typeId" placeholder="Type..."/>
                                                                    <form:errors path="name" cssClass="error">Must not be blank and must contain at least 3 characters</form:errors>
                                                                    <c:if test="${ticketTypeFail == true}">
                                                                        Name already exist
                                                                    </c:if>
                                                                    <label>
                                                                        <input hidden value="${ticketType.name}" name="oldName"/>
                                                                    </label>
                                                                </div>
