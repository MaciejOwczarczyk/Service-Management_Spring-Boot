        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-auto">
                    <div class="card-body">
                        <div class="container">
                            <form:form method="post" modelAttribute="plannerList">
                                <!-- Outer Row -->
                                                    ...
                                                    <div class="col-lg-auto">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-auto">Save intervention</h1>
                                                            </div>
                                                            <form class="user">
                                                                <c:if test="${dateFailed == true}">
                                                                    <tr class="error">End date should be greater than start date !</tr>
                                                                </c:if><span/>
                                                                <table class="table-responsive-xl" id="dataTable" width="100%" cellspacing="4">
                                                                    <thead>
                                                                    <tr>
                                                                        <th>Technician</th>
                                                                        <th>Date from</th>
                                                                    ...
                                                                    <tbody>
                                                                    <c:forEach items="${plannerList.planners}" var="plan" varStatus="status">
                                                                        <tr>
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <form:select path="planners[${status.index}].user" items="${technicians}" value="${plan.user.id}" name="technicy" itemLabel="fullName" itemValue="id" class="form-control form-control-user" id="techniciansId"/>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <form:input type="date" path="planners[${status.index}].start" value="${plan.start}" class="form-control " pattern="yyyy-MM-dd"/>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <form:input type="date" path="planners[${status.index}].end" value="${plan.end}" class="form-control" pattern="yyyy-MM-dd"/>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </c:forEach>
