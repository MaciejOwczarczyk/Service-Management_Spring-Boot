...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Charts -->
        <li class="nav-item">
            <a class="nav-link" href="../../Front/charts.html">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <a href="/serviceTicket/add" class="btn btn-warning btn-icon-split">
                            <span class="icon text-white-50">
                            <i class="fas fa-arrow-right"></i>
                            </span>
                    <span class="text">Add new ticket</span>
                </a>
                <a href="/serviceTicket/showAllOpen" class="btn btn-primary btn-icon-split">
                            <span class="icon text-white-50">
                            <i class="fas fa-arrow-right"></i>
                            </span>
                    <span class="text">Show all open</span>
                </a>
                <a href="/serviceTicket/showAllClosed" class="btn btn-primary btn-icon-split">
                            <span class="icon text-white-50">
                            <i class="fas fa-arrow-right"></i>
                            </span>
                    <span class="text">Show all closed</span>
                    <div/>
                </a><br>
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table" id="dataTable" width="100%" cellspacing="4">
                                <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Action</th>
                                ...
                                <tbody>
                                <c:forEach items="${serviceTickets}" var="serviceTicket">
                                    <tr>
                                        <td>${serviceTicket.id}</td>
                                        <td>
                                            <a href="/serviceTicket/close/${serviceTicket.id}"
                                               class="btn btn-success btn-circle">
                                                <i class="fas fa-archive"></i>
                                            </a>
                                            <a href="/serviceTicket/edit/${serviceTicket.id}"
                                               class="btn btn-dark btn-circle btn-circle-sm m-1">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                        </td>
                                        <td>${serviceTicket.notes}</td>
                                        <td>${serviceTicket.company.name}</td>
                                        <td>${serviceTicket.machine.model}</td>
                                        <td>${serviceTicket.ticketType.name}</td>
                                        <td>
                                            <c:forEach items="${serviceTicket.technicians}" var="technician">
                                                ${technician.fullName}<p/>
                                            </c:forEach>
                                        </td>
                                        <td>${serviceTicket.interventionStart}</td>
                                        <td>${serviceTicket.interventionEnd}</td>
