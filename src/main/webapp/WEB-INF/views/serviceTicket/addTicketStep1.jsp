        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="container">
                            <form:form method="get" modelAttribute="serviceTicket" action="/serviceTicket/addStep2">
                                <!-- Outer Row -->
                                                        ...
                                                        <div class="p-5">
                                                            ...
                                                            <form class="user">
                                                                <div class="form-group">
                                                                    Notes
                                                                    <form:textarea path="title" rows="4" class="form-control form-control-user" id="notesId" placeholder="Notes..."/>
                                                                    <form:errors path="title" cssClass="error">Must not be blank and must contain at least 5 characters</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Client
                                                                    <form:select path="company.id" class="form-control form-control-user" id="companyId">
                                                                        <form:option value="">Select one</form:option>
                                                                        <form:options items="${companies}" itemLabel="name" itemValue="id"/>
                                                                    </form:select>
                                                                    <c:if test="${companyFail == true}">
                                                                        <tr class="error">Select company</tr>
                                                                    </c:if>
                                                                </div>
                                                                <input type="submit" class="btn btn-success btn-user btn-block" value="Next">
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
