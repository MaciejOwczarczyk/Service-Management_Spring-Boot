        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="container">
                            <form:form method="get" modelAttribute="serviceTicket" action="/serviceTicket/addStep3">
                                <!-- Outer Row -->
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-5">Save ticket</h1>
                                                            </div>
                                                            <form class="user">
                                                                <div class="form-group">
                                                                    Machine
                                                                    <form:select path="machine.id" class="form-control form-control-user" id="machineId">
                                                                        <form:option value="">Select one</form:option>
                                                                        <form:options items="${machines}" itemLabel="model" itemValue="id"/>
                                                                    </form:select>
                                                                    <c:if test="${machineFail == true}">
                                                                        <tr class="error">Select machine</tr>
                                                                    </c:if>
                                                                </div>
                                                                <div class="form-group">
                                                                    Ticket type
                                                                    <form:select path="ticketType.id" class="form-control form-control-user" id="ticketTypeId">
                                                                        <form:option value="">Select one</form:option>
                                                                        <form:options items="${ticketTypes}" itemLabel="name" itemValue="id"/>
                                                                    </form:select>
                                                                    <c:if test="${ticketTypeFail == true}">
                                                                        <tr class="error">Select ticket type</tr>
                                                                    </c:if>
                                                                </div>
                                                                <a href="/serviceTicket/addStep1" class="btn btn-dark btn-user btn-block">Back</a>
                                                                <input type="submit" class="btn btn-success btn-user btn-block" value="Save">
                                                                </form>
                                                         </div>
                                                        </div>
                                                    </div>
...
<script src="<c:url value='../../../Front/vendor/jquery/jquery.min.js' />" type="text/javascript"></script>
<script src="<c:url value='../../../Front/vendor/bootstrap/js/bootstrap.bundle.min.js' />"
        type="text/javascript"></script>

<!-- Core plugin JavaScript-->
<script src="<c:url value='../../../Front/vendor/jquery-easing/jquery.easing.min.js' />"
        type="text/javascript"></script>

<!-- Custom scripts for all pages-->
<script src="<c:url value='../../../Front/js/sb-admin-2.min.js' />" type="text/javascript"></script>

<!-- Page level plugins -->
<script src="<c:url value='../../../Front/vendor/datatables/jquery.dataTables.min.js' />"
        type="text/javascript"></script>
<script src="<c:url value='../../../Front/vendor/datatables/dataTables.bootstrap4.min.js' />"
        type="text/javascript"></script>

<!-- Page level custom scripts -->
<script src="<c:url value='../../../Front/js/demo/datatables-demo.js' />" type="text/javascript"></script>
