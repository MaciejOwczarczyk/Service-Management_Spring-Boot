                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-4">Reopen ticket</h1>
                                                            </div>
                                                            <form class="user">
                                                                <form:hidden path="id"/>
                                                                <div class="form-group">
                                                                    Ticket status
                                                                    <form:select path="ticketStatus.id" items="${ticketStatuses}" itemLabel="name" itemValue="id" class="form-control form-control-user" id="ticketTypeId"/>
                                                                </div>
