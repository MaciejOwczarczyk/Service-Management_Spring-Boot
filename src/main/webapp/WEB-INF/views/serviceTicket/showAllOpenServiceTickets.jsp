    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <c:if test="${size == true}">
                    <a href="/serviceTicket/showAllToClose" class="btn btn-success btn-icon-split">
                            <span class="icon text-white-50">
                            <i class="fas fa-arrow-right"></i>
                            </span>
                        <span class="text">Show all to close</span>
                    </a>
                </c:if>
                            ...
                            <table class="table" id="dataTable" width="100%" cellspacing="4">
                                ...
                                <c:forEach items="${serviceTickets}" var="serviceTicket">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/serviceTicket/details/${serviceTicket.id}"
                                               class="btn btn-info btn-circle btn-circle">
