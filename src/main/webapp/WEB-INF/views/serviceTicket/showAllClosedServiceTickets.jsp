    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <a href="/serviceTicket/addStep1" class="btn btn-warning btn-icon-split">
                            <span class="icon text-white-50">
                            <i class="fas fa-arrow-right"></i>
                            </span>
                    <span class="text">Add new ticket</span>
                </a>
                <%--                <a href="/serviceTicket/showAllTickets" class="btn btn-primary btn-icon-split">--%>
                <%--                            <span class="icon text-white-50">--%>
                <%--                            <i class="fas fa-arrow-right"></i>--%>
                <%--                            </span>--%>
                <%--                    <span class="text">Show all tickets</span>--%>
                <%--                </a>--%>
                            ...
                            <table class="table" id="dataTable" width="100%" cellspacing="4">
                                ...
                                <c:forEach items="${serviceTickets}" var="serviceTicket">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/serviceTicket/editClosed/${serviceTicket.id}"
                                        ...
                                        <td class="text-area">${serviceTicket.solution}</td>
