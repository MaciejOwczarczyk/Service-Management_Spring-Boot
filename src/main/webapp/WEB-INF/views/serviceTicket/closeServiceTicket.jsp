                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-4">Close ticket</h1>
                                                            </div>
                                                            <form class="user">
                                                                <div class="form-group">
                                                                    Solution
                                                                    <form:textarea path="solution" class="form-control form-control-user" id="solutionId" placeholder="Solution..."/>
                                                                    <c:if test="${closeFailed == true}">
                                                                        <tr class="error">Solution must contain at least 10 characters</tr>
                                                                    </c:if>
                                                                </div>
                                                                <form:hidden path="id"/>
                                                                <input type="submit" class="btn btn-danger btn-user btn-block" value="Close">
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
