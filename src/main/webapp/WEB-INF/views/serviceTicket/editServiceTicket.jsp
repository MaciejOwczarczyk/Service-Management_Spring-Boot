        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="container">
                            <form:form method="post" modelAttribute="serviceTicket">
                                <!-- Outer Row -->
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-4">Save ticket</h1>
                                                            </div>
                                                            <form class="user">
                                                                <form:hidden path="id"/>
                                                                <div class="form-group">
                                                                    Client:
                                                                    ${serviceTicket.company.name}
                                                                </div>
                                                                <div class="form-group">
                                                                    Notes
                                                                    <form:textarea path="title" class="form-control form-control-user" id="titleId" placeholder="Notes..."/>
                                                                    <form:errors path="title" cssClass="error">Can't be blank and must be grater than 5 signs</form:errors>
                                                                </div>
                                                                <div class="form-group">
                                                                    Machine
                                                                    <form:select path="machine.id" items="${machines}" itemLabel="model" itemValue="id" class="form-control form-control-user" id="machineId"/>
                                                                </div>
                                                                <div class="form-group">
                                                                    Ticket type
                                                                    <form:select path="ticketType.id" items="${ticketTypes}" itemLabel="name" itemValue="id" class="form-control form-control-user" id="ticketTypeId"/>
                                                                </div>
                                                                <div class="form-group">
                                                                    Ticket status
                                                                    <form:select path="ticketStatus.id" items="${ticketStatuses}" itemLabel="name" itemValue="id" class="form-control form-control-user" id="ticketStatusId"/>
                                                                </div>
