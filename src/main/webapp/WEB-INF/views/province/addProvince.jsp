...
<head>
    ...
    <meta name="MaciejOwczarczyk" content="">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="container">
                            <form:form method="post" modelAttribute="province">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            <div class="text-center">
                                                                <h1 class="h4 text-gray-900 mb-4">Save Province</h1>
                                                            </div>
                                                            <form class="user">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label>
                                                                        <input hidden value="${province.name}" name="oldName"/>
                                                                    </label>
                                                                </div>
                                                                <input type="submit"
