                                    ...
                                    <div class="p-5">
                                        ...
                                        <form class="user">
                                            <div class="form-group">
                                                Login
                                                <form:input path="username" class="form-control form-control-user" placeholder="email/login" readonly="true"/>
                                                <form:errors cssClass="error" path="username">Must not be blank and must be email</form:errors>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    Password
                                                    <form:input path="password" type="password" class="form-control form-control-user" placeholder="password"/>
                                                    <form:errors cssClass="error" path="password">Must not be blank</form:errors>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    ...
                                                    <form:errors cssClass="error" path="firstName">Must not be blank</form:errors>
                                                </div>
                                                <div class="col-sm-6">
                                                    Last Name
                                                    <form:input path="lastName" class="form-control form-control-user" placeholder="last name"/>
                                                    <form:errors cssClass="error" path="lastName">Must not be blank</form:errors>
                                                </div>
                                                <div class="col-sm-6">
                                                    Role
                                                    <form:select path="roles" items="${roles}" itemLabel="name" itemValue="id" class="form-control form-control-user" id="roleId"/>
                                                    <form:errors path="roles" cssClass="error">Select roles</form:errors>
                                                </div>
                                                <div class="custom-checkbox">
                                                    Enable
                                                    <form:checkbox path="enabled" id="enableId" checked="true"/>
