                                        ...
                                        <form class="user">
                                            <div class="form-group">
                                                ...
                                                <form:errors cssClass="error"
                                                             path="username">Must not be blank and must be email</form:errors>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    ...
                                                    <form:errors cssClass="error"
                                                                 path="password">Must not be blank</form:errors>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    ...
                                                    <form:errors cssClass="error"
                                                                 path="firstName">Must not be blank</form:errors>
                                                </div>
                                                <div class="col-sm-6">
                                                    Last Name
                                                    ...
                                                    <form:errors cssClass="error"
                                                                 path="lastName">Must not be blank</form:errors>
                                                </div>
                                                <div class="form-group">
                                                    Role
                                                    ...
                                                    <form:errors path="roles"
                                                                 cssClass="error">Select authorities</form:errors>
                                                </div>
